...
module.exports = React.createClass({
    ...
    render: function render() {
        ...
        var props = blacklist(this.props, 'className', 'moment', 'saveText', 'timezone', 'upArrowIcon', 'downArrowIcon', 'prevMonthIcon', 'nextMonthIcon', 'onChange', 'onSave', 'minuteIncrement');
