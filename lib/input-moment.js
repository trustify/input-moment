...
module.exports = React.createClass({
    ...
    getError: function getError() {
        return !this.props.error ? null : React.createElement(
            'div',
    ...
    render: function render() {
        ...
        var props = blacklist(this.props, 'className', 'moment', 'saveText', 'timezone', 'upArrowIcon', 'downArrowIcon', 'prevMonthIcon', 'nextMonthIcon', 'onChange', 'onSave', 'minuteIncrement', 'error');
