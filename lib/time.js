...
module.exports = React.createClass({
    displayName: 'Time',
    minuteIncrements: undefined.generateMinuteArray(undefined.props.minuteIncrement),
    generateMinuteArray: function generateMinuteArray(minuteIncrement) {
        var increment = 15;
        if (minuteIncrement) {
    ...
    increaseMinutes: function increaseMinutes() {
        ...
        try {
            for (var _iterator = this.minuteIncrements[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    decreaseMinutes: function decreaseMinutes() {
        ...
        try {
            for (var _iterator2 = this.minuteIncrements[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
